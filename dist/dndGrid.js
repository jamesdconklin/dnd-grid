...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _renderedGrid = __webpack_require__(37);
	
	var _renderedGrid2 = _interopRequireDefault(_renderedGrid);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.default = _renderedGrid2.default;
	...
	var RenderedGrid = function (_PureComponent) {
	  ...
	  _createClass(RenderedGrid, [{
	    ...
	    value: function toStyle() {
	      ...
	      var mergedStyle = Object.assign({}, DEFAULT_STYLE, style);
	
	      var gradientDefinition = "linear-gradient(to right, " + mergedStyle.color + " " + (mergedStyle.lineWidth + "px, transparent " + mergedStyle.lineWidth + "px),") + ("linear-gradient(to bottom, " + mergedStyle.color + " ") + (mergedStyle.lineWidth + "px, transparent " + mergedStyle.lineWidth + "px)");
